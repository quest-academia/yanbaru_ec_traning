                ...
                {!! Form::open(['route' => 'signup.post']) !!}
                        <div class="form-group-sm">
                            ...
                            <div class="ml-3">
                                ...
                                {!! Form::text('last_name', old('last_name'), ['class' => 'form-control-sm d-inline col-sm-5']) !!}
                                {!! Form::label('first_name', '名', ['class' => 'd-inline ml-1']) !!}
                                {!! Form::text('first_name', old('first_name'), ['class' => 'form-control-sm d-inline col-sm-5']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group-sm">
                            ...
                            <div class="user-info">
                                {!! Form::text('zipcode', old('zipcode'), ['class' => 'ml-3 form-control-sm col-sm-6']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group-sm">
                            ...
                            <div class="clearfix">
                                ...
                                {!! Form::text('prefecture', old('prefecture'), ['class' => 'form-control-sm col-sm-8 ml-1 d-inline float-right']) !!}
                            </div>
                            <div class="mt-1 clearfix">
                                {!! Form::label('municipality', '市町村区', ['class' => 'd-inline ml-2']) !!}
                                {!! Form::text('municipality', old('municipality'), ['class' => 'form-control-sm col-sm-8 ml-1 d-inline float-right']) !!}
                            </div>
                            <div class="mt-1 clearfix">
                                {!! Form::label('address', '番地', ['class' => 'd-inline ml-2']) !!}
                                {!! Form::text('address', old('address'), ['class' => 'form-control-sm col-sm-8 ml-5 d-inline float-right']) !!}
                            </div>
                            <div class="mt-1 clearfix">
                                {!! Form::label('apartments', 'マンション・部屋番号', ['class' => 'd-block ml-2 mb-1']) !!}
                                {!! Form::text('apartments', old('apartments'), ['class' => 'form-control-sm col-sm-8 ml-1 d-inline float-right']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group-sm">
                            ...
                            <div class="pl-3">
                                {!! Form::email('email', old('email'), ['class' => 'form-control-sm d-inline w-100']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group-sm">
                            ...
                            <div class="pl-3">
                                {!! Form::text('phone_number', old('phone_number'), ['class' => 'form-control-sm d-inline w-100']) !!}
                            </div>
                        </div>
